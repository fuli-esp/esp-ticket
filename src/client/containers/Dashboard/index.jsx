              ...
              <TruCard
                content={
                  <div>
                    ...
                    <span className="uk-text-muted uk-text-small">总工单 (最近 {this.timespan.toString()}天)</span>
                    ...
                    <table className="uk-table">
                      ...
                      <tbody>
                        <tr className="uk-table-middle">
                          <td className="uk-width-6-10 uk-text-nowrap uk-text-muted uk-text-small">提出最多工单：</td>
                        ...
                        <tr className="uk-table-middle">
                          <td className="uk-width-6-10 uk-text-nowrap uk-text-muted uk-text-small">提出最多评论：</td>
                        ...
                        <tr className="uk-table-middle">
                          <td className="uk-width-6-10 uk-text-nowrap uk-text-muted uk-text-small">被安排最多工单：</td>
                        ...
                        <tr className="uk-table-middle">
                          <td className="uk-width-6-10 uk-text-nowrap uk-text-muted uk-text-small">最活跃工单：</td>
