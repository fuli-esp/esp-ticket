...
class DashboardContainer extends React.Component {
  ...
  render() {
    ...
    const lastUpdatedFormatted = this.props.dashboardState.lastUpdated
      ? moment(this.props.dashboardState.lastUpdated, 'YYYY-MM-DD hh:mm:ss').tz(tz).format(formatString)
      : 'Cache Still Loading...';
              ...
              <div>
                <div className={'uk-float-right'} style={{ minWidth: 250 }}>
                  <div style={{ marginTop: 8 }}>
                    <SingleSelect
                      items={[
                        { text: t('last_30_days'), value: '30' },
                        { text: t('last_60_days'), value: '60' },
                        { text: t('last_90_days'), value: '90' },
                        { text: t('last_180_days'), value: '180' },
                        { text: t('last_365_days'), value: '365' },
                      ]}
                      defaultValue={'30'}
            ...
            <Grid>
                ...
                <TruCard
                  content={
                    <div>
                      ...
                      <span className="uk-text-muted uk-text-small">{t('total_tickets')} ({t('last')} {this.timespan.toString()} {t('days')})</span>
                ...
                <TruCard
                  content={
                    <div>
                      ...
                      <span className="uk-text-muted uk-text-small">{t('completed_tickets')}</span>
                ...
                <TruCard
                  content={
                    <div>
                      ...
                      <span className="uk-text-muted uk-text-small">{t('avg_response_time')}</span>
      
                      <h2 className="uk-margin-remove">
                        <CountUp endNumber={this.props.dashboardState.ticketAvg || 0} extraText={t('hours')} />
                      </h2>
                    </div>
                  }
                />
                ...
                <TruCard
                  header={
                    <div className="uk-text-left">
                      <h6 style={{ padding: 15, margin: 0, fontSize: '14px' }}>{t('ticket_timeline')}</h6>
                    </div>
                  }
                  fullSize={true}
                  hover={false}
              ...
              <GridItem width={'1-2'} extraClass={'uk-margin-medium-top'}>
                <TruCard
                  ...
                  header={
                    <div className="uk-text-left">
                      <h6 style={{ padding: 15, margin: 0, fontSize: '14px' }}>{t('top_5_groups')}</h6>
                    </div>
                  }
                  content={
                    <div>
              ...
              <GridItem width={'1-2'} extraClass={'uk-margin-medium-top'}>
                <TruCard
                  ...
                  header={
                    <div className="uk-text-left">
                      <h6 style={{ padding: 15, margin: 0, fontSize: '14px' }}>{t('top_10_tags')}</h6>
                    </div>
                  }
                  content={
                    <div>
              ...
              <GridItem width={'1-2'} extraClass={'uk-margin-medium-top'}>
                <TruCard
                  ...
                  header={
                    <div className="uk-text-left">
                      <h6 style={{ padding: 15, margin: 0, fontSize: '14px' }}>{t('overdue_tickets')}</h6>
                    </div>
                  }
                  content={
                    <div className="uk-overflow-container">
                      <table className="uk-table">
                        <thead>
                          <tr>
                            <th className="uk-text-nowrap">{t('ticket')}</th>
                            <th className="uk-text-nowrap">{t('status')}</th>
                            <th className="uk-text-nowrap">{t('subject')}</th>
                            <th className="uk-text-nowrap uk-text-right">{t('last_updated')}</th>
                          </tr>
                        </thead>
                        <tbody>
                          {this.props.dashboardState.overdueTickets.map((ticket) => {
                            return (
                              <tr key={ticket.get('_id')} className={'uk-table-middle'}>
                                ...
                                <td className={'uk-width-1-10 uk-text-nowrap'}>
                                  <span className={'uk-badge ticket-status-open uk-width-1-1 ml-0'}>{t('open')}</span>
                                </td>
              ...
              <GridItem width={'1-2'} extraClass={'uk-margin-medium-top'}>
                <TruCard
                  header={
                    <div className="uk-text-left">
                      <h6 style={{ padding: 15, margin: 0, fontSize: '14px' }}>{t('data_overview')}</h6>
                    </div>
                  }
                  content={
                    <div className="uk-overflow-container">
                      <table className="uk-table">
                        <thead>
                          <tr>
                            <th className="uk-text-nowrap">{t('metric')}</th>
                            <th className="uk-text-nowrap uk-text-right">{t('value')}</th>
                          </tr>
                        </thead>
                        <tbody>
                          <tr className="uk-table-middle">
                            <td className="uk-width-6-10 uk-text-nowrap uk-text-muted uk-text-small">{t('most_tickets_requested')}：</td>
                          ...
                          <tr className="uk-table-middle">
                            <td className="uk-width-6-10 uk-text-nowrap uk-text-muted uk-text-small">{t('most_comments_requested')}：</td>
                          ...
                          <tr className="uk-table-middle">
                            <td className="uk-width-6-10 uk-text-nowrap uk-text-muted uk-text-small">{t('most_assigned_tickets')}：</td>
                          ...
                          <tr className="uk-table-middle">
                            <td className="uk-width-6-10 uk-text-nowrap uk-text-muted uk-text-small">{t('most_active_ticket')}：</td>
