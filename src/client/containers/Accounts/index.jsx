  ...
  render() {
    const items =
      ...
      this.props.accountsState.accounts.map((user) => {
        ...
        let actionMenu = [<DropdownItem key={0} text={'编辑'} onClick={(e) => this.onEditAccountClicked(e, user)} />];
        if (user.get('deleted'))
          actionMenu.push(<DropdownItem key={2} text={'启用'} onClick={(e) => this.onEnableAccountClicked(e, user)} />);
        else
          actionMenu.push(
            <DropdownItem
              key={1}
                ...
                <ul className="tru-list">
                  <li>
                    <div className="tru-list-content">
                      <span className="tru-list-heading">角色</span>
                  ...
                  <li>
                    {customer && user.get('groups') && (
                      <div className="tru-list-content">
                        <span className="tru-list-heading">代理店组</span>
                    ...
                    {!customer && user.get('teams') && (
                      <div className="tru-list-content">
                        <span className="tru-list-heading">团队</span>
                        <span className="uk-text-small uk-text-muted uk-text-truncate">
                  ...
                  {!customer && user.get('departments') && (
                    <li>
                      <div className="tru-list-content">
                        <span className="tru-list-heading">部门</span>
                        <span className="uk-text-small uk-text-muted uk-text-truncate">
