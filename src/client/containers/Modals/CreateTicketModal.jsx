        ...
        <form className={'uk-form-stacked'} onSubmit={e => this.onFormSubmit(e)}>
          ...
          <div className='uk-margin-medium-bottom'>
            <Grid>
              {allowAgentUserTickets && (
                <GridItem width={'1-3'}>
                  <label className={'uk-form-label'}>所属人</label>
                  <SingleSelect
                    showTextbox={true}
              ...
              <GridItem width={allowAgentUserTickets ? '2-3' : '1-1'}>
                <label className={'uk-form-label'}>组</label>
                <SingleSelect
                  showTextbox={false}
                  items={mappedGroups}
          ...
          <div className='uk-margin-medium-bottom'>
            <Grid>
              ...
              <GridItem width={'2-3'}>
                <label className={'uk-form-label'}>标签</label>
                <SingleSelect
                  showTextbox={false}
          ...
          <div className='uk-margin-medium-bottom'>
            <label className={'uk-form-label'}>优先级</label>
            <div
          ...
          <div className='uk-modal-footer uk-text-right'>
            ...
            <Button text={'创建'} style={'primary'} flat={true} type={'submit'} />
          </div>
        </form>
      </BaseModal>
    )
