          ...
          <form className="uk-form-stacked" onSubmit={(e) => this.onSubmitSaveAccount(e)}>
            <div className="uk-margin-medium-bottom uk-clearfix">
              <div className="uk-float-left" style={{ width: '50%', paddingRight: '20px' }}>
                <label className={'uk-form-label'}>姓名</label>
                <input
                  type="text"
                  className={'md-input'}
                  value={this.name}
            ...
            {edit && (
              <div>
                <div className="uk-margin-medium-bottom uk-clearfix">
                  ...
                  <div className="uk-float-left uk-width-1-2">
                    <label className={'uk-form-label'}>再次确认密码</label>
                    <input
                      type="password"
                      className={'md-input'}
            ...
            {edit && (
              <div className="uk-margin-medium-bottom">
                <label className={'uk-form-label'}>角色</label>
                <SingleSelect
                  items={roles}
                  width={'100'}
                  showTextbox={false}
            ...
            {this.props.groups && customer && (
              <div className="uk-margin-medium-bottom">
                <label className="uk-form-label">代理店组</label>
                <MultiSelect
                  items={groups}
            ...
            {!customer && (
              <div>
                <div className="uk-margin-medium-bottom">
                  <label className="uk-form-label">团队</label>
                  <MultiSelect
                    items={teams}
                ...
                <div className="uk-margin-medium-bottom">
                  <label className="uk-form-label">部门</label>
                  <MultiSelect
                    items={departments}
            ...
            <div className="uk-modal-footer uk-text-right">
              ...
              <Button text={'保存账号'} flat={true} waves={true} style={'primary'} type={'submit'} disabled={!edit} />
            </div>
          </form>
        </div>
      </BaseModal>
