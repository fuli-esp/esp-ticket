...
(function () {
  ...
  function sendPushNotification(tpsObj, data) {
    ...
    switch (data.type) {
      case 1:
        title = '工单 #' + ticket.uid + ' 被创建';
        content = ticket.owner.fullname + ' 提交工单';
        users = _.map(ticket.group.sendMailTo, function (o) {
          return o._id;
        });
        break;
      case 2:
        title = '工单 #' + ticket.uid + ' 更新';
        ...
        break;
      case 3:
        title = message.owner.fullname + ' 给你发了一条消息';
        break;
      case 4:
        ...
        title = '分配工单 #' + ticketUid;
        content = '你被分配工单 #' + ticketUid;
        users = [assigneeId];
        break;
      default:
        title = '';
